				...
				<div style={{ width: "80%" }}>
					<div className="docs-content">
						...
						<div className="category-container">
							...
							<a className="category-element" href="docs/deploy-to-aws-lightsail/manage-application" id="deploy-to-azure">Manage Application</a>
						</div>
						<div className="category-container">
							...
							<a className="category-element" href="docs/deploy-to-azure/cicd" id="deploy-to-heroku">CI/CD</a>
						</div>
						<div className="category-container">
							...
							<a className="category-element" href="docs/deploy-to-heroku/cicd" id="flow-structure">CI/CD</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">Flow Structure</h3>
							<a className="category-element" href="docs/messages/set-message-property-fixed" id="messages-design">Flows Structure</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">Message Design</h3>
							<a className="category-element" href="docs/messages/set-message-property-fixed" id="messages">Message Design</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">Messages</h3>
							...
							<a className="category-element" href="docs/messages/map-range" id="flow-control">Map a property between different numeric ranges</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">Flow Control</h3>
							...
							<a className="category-element" href="docs/flow-control/join-streams" id="error-handling">Create a single message from separate streams of messages</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">Error Handling</h3>
						...
						<div className="category-container">
							...
							<a className="category-element" href="docs/data-formats/split-text" id="http-endpoints">Split text into one message per line</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">HTTP Endpoints</h3>
							...
							<a className="category-element" href="docs/http-endpoints/work-with-cookies" id="http-requests">Work with cookies</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">HTTP Requests</h3>
							...
							<a className="category-element" href="docs/http-requests/set-request-headers" id="mqtt">Set a request header</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">MQTT</h3>
							...
							<a className="category-element" href="docs/mqtt/parsed-json" id="odata">Receive a parsed JSON message</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">OData</h3>
							...
							<a className="category-element" href="docs/odata/create-an-odata-service" id="sequelize">Create an OData Service</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">Sequelize</h3>
							<a className="category-element" href="docs/sequelize/execute-a-query" id="auth">Execute a Query</a>
						</div>
						<div className="category-container">
							...
							<a className="category-element" href="docs/auth/verify-jwt" id="jsonata">Verify JWT</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">JSONata</h3>
							<a className="category-element" href="docs/jsonata/jsonata-node">JSONata Node</a>
							<a className="category-element" href="docs/jsonata/jsonata-explorer" id="breakpoint">JSONata Explorer</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">Breakpoint</h3>
							<a className="category-element" href="docs/breakpoint/breakpoint-introduction">Introduction</a>
							<a className="category-element" href="docs/breakpoint/breakpoint-how-to-use" id="open-api">How to use</a>
						</div>
						<div className="category-container">
						...
						<div className="category-container">
							...
							<a className="category-element" href="docs/designer/designer" id="monitor">Designer</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">Monitor</h3>
							<a className="category-element" href="docs/monitor/monitor-introduction">Introduction</a>
							<a className="category-element" href="docs/monitor/monitor-how-to-use" id="release-management">How to use</a>
						</div>
						<div className="category-container">
							<h3 className="category-title">Release Management</h3>
